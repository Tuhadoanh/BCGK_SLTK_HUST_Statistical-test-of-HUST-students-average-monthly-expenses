...
\begin{itemize}
    \item \textbf{Giả thuyết $H_0$:} $\mu \le 2.0$ 
    \textit{(Chi tiêu trung bình thấp hơn hoặc bằng 2.0 triệu, thị trường không khả thi).}
    
    \item \textbf{Giả thuyết $H_1$:} $\mu > 2.0$ 
...
Em so sánh p-value với mức ý nghĩa $\alpha$:
\begin{itemize}
    \item P-value = $0.00000738$
    \item Mức ý nghĩa $\alpha = 0.05$
\end{itemize}
Vì $p\text{-value} (0.00000738) << \alpha (0.05)$, em có bằng chứng thống kê cực kỳ mạnh mẽ để \textbf{bác bỏ giả thuyết $H_0$}.